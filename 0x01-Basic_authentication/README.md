...
We are playing around with a simple user model in order to understand basic authentication using python

## We will be completing the following tasks
### Enjoy the lesson and make sure to learn along the way
