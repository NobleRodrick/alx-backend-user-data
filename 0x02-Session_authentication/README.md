# We are working with session authentication

In this project we will be learning how to authenticate a user session

## these will be the tasks that we are going to be working on
## We are all learning together, hold on tight
## And welcome🧑👩
